...
public class FrmVistaProvedor extends javax.swing.JInternalFrame {
static int Comprueba2;
    public FrmVistaProvedor() {
        initComponents();
        mostrar("");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Provedores Registrados en el Sistema");
    ...
    private void jTablaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMousePressed
        if (evt.getClickCount() == 2) {
            ...
            if(Comprueba2 == 2){
                 FrmComprasDetalle.txtCod_proveedor.setText(cod);
                 FrmComprasDetalle.txtNombre_provedor.setText(nombre); 
            } 
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVistaProvedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVistaProvedor().setVisible(true);
            }
        });
    }
