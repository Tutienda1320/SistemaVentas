...
public class FRMPRINCIPAL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuBar.setBorder(javax.swing.BorderFactory.createBevelBorder(0));
        ...
        jMICaja.setBackground(new java.awt.Color(36, 33, 33));
        jMICaja.setForeground(new java.awt.Color(245, 245, 245));
        jMICaja.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesForm/DescProd.png"))); // NOI18N
        jMICaja.setText("Caja");
        jMICaja.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        jMenuItem3.setLabel("Provedores");
        ...
        Inventario.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.ALT_MASK));
        Inventario.setBackground(new java.awt.Color(36, 33, 33));
        ...
        jMenuItem1.setText("Herramienta de devoluciones");
        ...
        JmiHerramientas.add(jMenuItem1);
        ...
        jMenuItem4.setText("Herramientas de compras");
        ...
        JmiHerramientas.add(jMenuItem4);

        jMenuItem5.setBackground(new java.awt.Color(36, 33, 33));
        jMenuItem5.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jMenuItem5.setForeground(new java.awt.Color(255, 255, 255));
        jMenuItem5.setText("Configuracion Empresa");
        jMenuItem5.setOpaque(true);
        JmiHerramientas.add(jMenuItem5);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        FrmMostrarCompras form = new FrmMostrarCompras();
        deskPricipal.add(form);
    ...
    javax.swing.JMenuItem Inventario;
